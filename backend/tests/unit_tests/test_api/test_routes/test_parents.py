...
class Test_Parents_Positive:
    ...
    async def test_create_parent_OK(
        ...
        res = await async_test_client.post("/api/parents/post", json=Parent3_Create)
    ...
    async def test_read_parent_by_id_OK(
        ...
        res = await async_test_client.get("/api/parents/get_by_id", params=params)
    ...
    async def test_read_multiple_parents_OK(
        ...
        query_schema = jsonable_encoder(ParentOptionalSchema(height=1.90))
        ...
        res = await async_test_client.post(
            "/api/parents/get_optional", json=query_schema
        )
    ...
    async def test_delete_parent_OK(
        ...
        res = await async_test_client.delete("/api/parents/delete", params=params)
    ...
    async def test_get_parent_children_by_id_OK(
        ...
        monkeypatch.setattr(
            ParentRepository, "get_parent_children_by_id", get_parent_children_by_id
        )

        res = await async_test_client.get("/api/parents/get_children", params=params)
